    ...
    return (
        <>
            <div className="ad-page-header">
                <div>
                    <h1 style={{ fontFamily: fontTitle, fontSize: 26, fontWeight: 800, color: C.text, margin: 0 }}>Settings</h1>
                    <p style={{ color: C.muted, fontSize: 14, margin: '4px 0 0' }}>Manage your profile and preferences.</p>
                </div>
            </div>

            <div className="ad-grid-2" style={{ alignItems: 'stretch' }}>
                <div className="ad-panel">
                    <h2 style={{ fontFamily: fontTitle, fontSize: 17, fontWeight: 800, color: C.text, margin: '0 0 1.2rem' }}>My Profile</h2>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: '1.4rem' }}>
                        ...
                        <div>
                            ...
                            <div style={{ fontSize: 13, color: C.muted }}>Premium Client</div>
                        </div>
                    </div>
                ...
                <div className="ad-panel">
                    <h2 style={{ fontFamily: fontTitle, fontSize: 17, fontWeight: 800, color: C.text, margin: '0 0 1.2rem' }}>Preferences &amp; Security</h2>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
                        {[
                            { label: 'Payment notifications', desc: 'Receive an email for every completed payment.', state: notifPayments, setState: setNotifPayments },
                            { label: 'Promotional offers', desc: 'Receive news and offers from CardFlow.', state: notifPromos, setState: setNotifPromos },
                            { label: 'Two-factor authentication', desc: 'Require an OTP code for every payment.', state: twoFactor, setState: setTwoFactor },
                        ].map(pref => (
