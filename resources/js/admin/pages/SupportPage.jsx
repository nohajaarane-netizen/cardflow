...
const FAQ = [
    { q: 'Comment bloquer la carte d\'un client ?', a: 'Allez dans "Cartes" ou "Clients", ouvrez le menu de la carte concernée et cliquez sur "Bloquer". L\'action est immédiate.' },
    { q: 'Comment émettre une nouvelle carte ?', a: 'Depuis le Tableau de bord, utilisez le formulaire "Émettre une carte" : sélectionnez un client, un type et un plafond, puis validez.' },
    { q: 'Que signifie une transaction "suspecte" ?', a: 'Le moteur de paiement a détecté un comportement anormal (montant, fréquence, marchand) et a généré une alerte dans "Litiges".' },
    { q: 'Comment exporter mes données ?', a: 'La page "Rapports" permet de télécharger un export CSV des clients, cartes ou transactions.' },
]
        ...
        <>
            <div className="ad-page-header">
                <div>
                    ...
                    <p style={{ color: C.muted, fontSize: 14, margin: '4px 0 0' }}>Besoin d'aide ? Consultez la FAQ ou contactez l'équipe technique.</p>
                </div>
            </div>
